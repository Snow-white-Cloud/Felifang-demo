...
| Цвета | Дизайнер, лоровед, генератор идей | скоро |
...
- [Спринты](./docs/sprints/sprint-history.md) — процесс разработки.
...
Можете ознакомиться с [полным списком](./CONTRIBUTING.md) необходимых людей, а также требованиями и выгодой, которую получите от сотрудничества. Несомненно, в планах на будущее ввести законные материальные поощрения за деятельность.

**Как присоединиться:**
Заполните [форму](ссылка_на_Google_Form) или напишите в [ВК владельцу](https://vk.ru/snow_white_cloud) проекта, указав, чем можете быть полезны и чем хотите заниматься.
...
**Архитектура:** схемы микросервисов, описание взаимодействия между Auth, Social и Game, выбор технологий и обоснование решений будут скоро опубликованы в открытом доступе для ознакомления.
